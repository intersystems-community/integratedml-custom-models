...
def fraud_transactions(sample_transaction_data):
    ...
    return sample_transaction_data[sample_transaction_data['is_fraud'] == True].reset_index(drop=True)


@pytest.fixture(scope="session")
def legitimate_transactions(sample_transaction_data):
    """Filter legitimate transactions from sample data."""
    return sample_transaction_data[sample_transaction_data['is_fraud'] == False].reset_index(drop=True)
