...
class TestEndToEndWorkflow(unittest.TestCase):
    ...
    def test_workflow_with_dirty_data(self):
        ...
        self.assertGreater(accuracy, 0.45)  # Should still work reasonably well with dirty data
    ...
    def test_performance_comparison_workflow(self):
        ...
        configurations = [
            ...
            {'name': 'debt_ratios_only', 'params': {
                'enable_debt_ratio': True,
                'enable_interaction_terms': False,
                'enable_risk_scoring': False
            }},
            {'name': 'full_features', 'params': {
                'enable_debt_ratio': True,
                'enable_interaction_terms': True,
                'enable_risk_scoring': True
            }}
        ...
        for config_name, metrics in results.items():
            ...
            self.assertGreater(metrics['auc'], 0.5,
                             f"{config_name} AUC too low: {metrics['auc']}")
...
class TestErrorHandlingIntegration(unittest.TestCase):
    ...
    def test_graceful_failure_handling(self):
        ...
        try:
            X_minimal, y_minimal = generator.generate_dataset(n_samples=5, default_rate=0.4)
