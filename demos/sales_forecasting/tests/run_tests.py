...
class TestResult:
    ...
    def __init__(self, name: str, tests_run: int, failures: int, errors: int, 
                 skipped: int = 0, duration: float = 0.0):
        self.name = name
        ...
        self.success_rate = (tests_run - failures - errors) / tests_run * 100 if tests_run > 0 else 0
    
    def __str__(self):
        return (f"{self.name}: {self.tests_run} tests, "
...
class SalesTestRunner:
    ...
    def run_test_suite(self, suite_name: str, test_classes: List, 
                      standalone_runner: Optional = None) -> TestResult:
    ...
    def print_final_summary(self):
        ...
        if overall_success_rate >= 95:
            ...
            print("✗ Poor test coverage, significant issues require immediate attention")
...
def main():
    ...
    parser.add_argument(
        '--suite', 
        choices=['all', 'unit', 'model', 'integration', 'performance', 'quick', 'smoke'],
        default='all',
