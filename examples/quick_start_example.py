...
def create_sample_credit_data():
    ...
    feature_names = [
        'checking_balance', 'duration_months', 'credit_history', 'purpose',
        'amount', 'savings_balance', 'employment_duration', 'installment_rate',
        'personal_status', 'other_debtors', 'residence_history', 'property',
        'age', 'installment_plans', 'housing'
    ]
...
def demo_credit_risk_model():
    ...
    print("-" * 40)
    for i in range(5):
        print(f"Customer {i+1}: Risk Probability = {probabilities[i, 1]:.3f}, "
...
def demo_fraud_detection_ensemble():
    ...
    feature_names = [
        ...
        'customer_age', 'account_balance', 'transaction_velocity',
        'location_risk_score', 'merchant_risk_score', 'payment_method',
        'previous_fraud_count', 'account_age_days'
    ]
    ...
    try:
        ...
        print(f"Accuracy: {accuracy:.3f}")
        print(f"Fraud Detection Rate: {fraud_detected}/{total_fraud} "
        ...
        for idx in fraud_indices:
            print(f"Transaction {idx}: Fraud Probability = {probabilities[idx, 1]:.3f}, "
